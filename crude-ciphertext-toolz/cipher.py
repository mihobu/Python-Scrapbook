...
# cipher.py -- Prompt user for plaintext; encode using simple
#              substitution cipher
#
...
# ----------------------------------------------------------------------------
plaintext = raw_input("Enter sentence to encrypt: ")
shift_s   = raw_input("Enter shift value: ")
...
print "The encoded phrase is: %s" % encoded_text
print ""
